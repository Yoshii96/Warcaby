...
public class Data {
    ...
    //rozmiar planszy
    private int[][] board;
    //cała tablica, jeżeli 0-puste, 1-nasze, 2-przeciwnika
    //wysyla to zazwyczaj logic do visuala
    //na poczatek wszędzie 0;
    private int[] clicked;
    //tablica, która trzyma x i y, współrzędne kliknięcia, przy inicjalizacji x = -1 y = -1
    private int[][] moves;
    //tablica możliwch ruchów, maksymalnie 4 możliwe ruchy, współrzędne x i y mówią jakie pole możemy wybrać, na poczatek x = -1 y = -1
    private int[] chosenMove;
    //tablica, króra trzyma x i y, wybrany ruch, jeden z możliwych, na początek x = -1 y = -1
    private int[][] lastMove;
    //ostatni ruch komputera, pierwszy wiersz tablicy = gdzie stal wczesniej, drugi wiersz = gdzie teraz, na początek x = -1 y = -1
